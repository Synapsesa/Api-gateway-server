...
public class SubscriptionRateLimiterGatewayFilterFactory extends AbstractGatewayFilterFactory<SubscriptionRateLimiterGatewayFilterFactory.Config> {
    ...
    public SubscriptionRateLimiterGatewayFilterFactory(RateLimiter rateLimiter, QueueEventPublisher queueEventPublisher) {
    ...
    private Mono<Void> handleQueueing(ServerWebExchange exchange, AuthenticatedUser user) {
